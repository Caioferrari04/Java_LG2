class Main {
    public static void main(String[] args) {
        ...
        System.out.println(circuloUm.getRaio());
        ...
        System.out.println(circuloDois.getRaio());
        ...
        System.out.println(circuloTres.getRaio());
        ...
        System.out.println(retanguloUm.getBase());
        System.out.println(retanguloUm.getAltura());
        ...
        System.out.println(retanguloDois.getBase());
        System.out.println(retanguloDois.getAltura());
        ...
        System.out.println(retanguloTres.getBase());
        System.out.println(retanguloTres.getAltura());
